...
open class ItemsAPI: APIBase {
  ...
  "url" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func itemsGet(query: String? = nil, page: Int32? = nil, perPage: Int32? = nil, completion: @escaping ((_ data: [Item]?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: Observable<[Item]>
     */
    open class func itemsGet(query: String? = nil, page: Int32? = nil, perPage: Int32? = nil) -> Observable<[Item]> {
        return Observable.create { observer -> Disposable in
  ...
  "url" : "aeiou"
     ...
     - returns: RequestBuilder<[Item]> 
     */
    open class func itemsGetWithRequestBuilder(query: String? = nil, page: Int32? = nil, perPage: Int32? = nil) -> RequestBuilder<[Item]> {
        let path = "/items"
        let URLString = CHQiitaApiClientAPI.basePath + path
        let parameters: [String:Any]? = nil
  ...
  "url" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func usersUserIdStocksGet(userId: String, page: Int32? = nil, perPage: Int32? = nil, completion: @escaping ((_ data: [Item]?,_ error: Error?) -> Void)) {
        usersUserIdStocksGetWithRequestBuilder(userId: userId, page: page, perPage: perPage).execute { (response, error) -> Void in
            completion(response?.body, error);
        }
    }
    ...
    /**
     ...
     - returns: Observable<[Item]>
     */
    open class func usersUserIdStocksGet(userId: String, page: Int32? = nil, perPage: Int32? = nil) -> Observable<[Item]> {
        return Observable.create { observer -> Disposable in
            usersUserIdStocksGet(userId: userId, page: page, perPage: perPage) { data, error in
                if let error = error {
                    observer.on(.error(error as Error))
                } else {
                    observer.on(.next(data!))
  ...
  "url" : "aeiou"
     ...
     - returns: RequestBuilder<[Item]> 
     */
    open class func usersUserIdStocksGetWithRequestBuilder(userId: String, page: Int32? = nil, perPage: Int32? = nil) -> RequestBuilder<[Item]> {
        var path = "/users/{user_id}/stocks"
