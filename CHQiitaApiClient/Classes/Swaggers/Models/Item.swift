...
open class Item: JSONEncodable {
    ...
    public init(id: String, user: User?=nil, title: String, body: String?=nil, renderedBody: String?=nil, url: String?=nil, likesCount: Int32?=nil, commentsCount: Int32?=nil, tags: [Tag]?=nil, createdAt: Date, updatedAt: Date) {
        self.id = id
        self.user = user
        self.title = title
        self.body = body
